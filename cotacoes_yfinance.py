"""
Script : load_cotacoes_yfinance.py
...
Execução:
  ...
  python load_cotacoes_yfinance.py --desde 2004-01-01 # limitar período inicial
"""
...
DATA_INICIO   = "2000-01-01"  # cobre todos os IPOs brasileiros modernos
